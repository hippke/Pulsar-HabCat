...
def plot_mwd(RA,Dec,org=0,title='Exoplants', projection='mollweide'):
    ...
    ax.scatter(numpy.radians(x),numpy.radians(Dec), alpha=0.5)  # convert degrees to radians
...
plot_mwd(ra_coord,de_coord, org=90, title ='HabCat stars')
plt.savefig("habcat_skymap.pdf", bbox_inches = 'tight')
plt.show()
